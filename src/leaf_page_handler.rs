...
mod tests {
    ...
    fn test_add_remove_pages() {
        ...
        for i in 1u32..1024 {
            ...
            let tuple = Tuple::new(i.to_le_bytes().to_vec(), i.to_le_bytes().to_vec(), new_version);
        ...
        // We should be using 18 pages - the two created at the start and the free_pages_allocated.
