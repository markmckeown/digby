...
impl TreeDeleteHandler {
    ...
    fn delete_key_from_tree(key: &Vec<u8>, 
        ...
        let new_root_page_no= TreeDeleteHandler::fix_stack(key, &mut dir_pages, free_page_tracker, 
            page_cache, new_version, new_leaf_page_no, old_leaf_page_no);
    ...
    fn fix_stack(key: &Vec<u8>, 
        ...
        return TreeDeleteHandler::fix_stack_page_del(key, dir_pages, free_page_tracker, 
                page_cache, new_version, old_leaf_page_no);
    }

    fn fix_stack_page_del(key: &Vec<u8>, 
        dir_pages: &mut Vec<TreeDirPage>, 
        free_page_tracker: &mut FreePageTracker, 
        page_cache: &mut PageCache, 
        new_version: u64, 
        ...
        if dir_pages.is_empty() {
            ...
            let mut new_root = TreeLeafPage::create_new(page_cache.get_page_config(),
             new_root_page_no);
        ...
        return TreeDeleteHandler::fix_dir_stack(key, dir_pages, free_page_tracker, page_cache, new_version);
    }


    fn fix_dir_stack(key: &Vec<u8>,
        dir_pages: &mut Vec<TreeDirPage>, 
        free_page_tracker: &mut FreePageTracker, 
        page_cache: &mut PageCache, 
        new_version: u64) -> u32 {
