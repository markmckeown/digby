...
impl StoreTupleProcessor {
    ...
    fn store_tuple_tree(
        ...
        let mut dir_refs =
            TreeDirHandler::handle_tree_leaf_store(db_config, dir_page, leaf_dir_entries);
        ...
        while !dir_pages.is_empty() {
            dir_page = dir_pages.pop().unwrap();
            dir_refs = TreeDirHandler::handle_tree_dir_store(db_config, dir_page, dir_entries);
        ...
        let new_tree_dir_page = DirPage::create_new(
    ...
    fn write_tree_dir_pages(
        ...
        TreeDirHandler::map_dir_pages(&mut dir_pages, free_pg_mgr, page_cache, new_version);
    ...
    fn write_leaf_pages(
        ...
        // free page tracker.
        LeafPageHandler::map_pages(&mut leaf_pages, free_pg_mgr, page_cache, new_version);
    ...
    fn store_tuple_tree_root_single(
        ...
        let new_tree_dir_page = DirPage::create_new(
            ...
            PageNo::new(
                PageType::DirPage,
                page_cache.get_db_config().dir_pg_blk_cnt_shift,
                0,
            ),
            0,
        );
...
mod tests {
    ...
    fn test_root_is_leaf_add_1() {
        ...
        root_tree_page_no.set_type(PageType::LeafPage);
        let mut leaf_page =
